...
<body>
    ...
    <div class="container d-flex justify-content-center my-5">
        <div class="card mb-3" style="max-width: 800px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="images/front-img.png" class="img-fluid rounded-start" alt="front image" />
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Forms</h5>
                        <p class="card-text">
                            Every extra field in your form is a reason for someone to quit. </p>
                        <p class="card-text"><small class="text-muted">- Luke Wroblewski</small></p>
                    </div>
                </div>
            </div>
        </div>
