...
<body>
    ...
    <p class="h4 text-success text-center my-4">Education Information</p>
    ...
    <table class="table table-bordered table-striped text-center">
      <tbody>
        <tr>
          ...
          <td>${educationDTO.degree}</td>
        </tr>
        <tr>
          <th scope="row">Branch</th>
          <td>${educationDTO.branch}</td>
        </tr>
        <tr>
          <th scope="row">College Name</th>
          <td>${educationDTO.collegeName}</td>
        </tr>
        <tr>
          <th scope="row">Year of Passing</th>
          <td>${educationDTO.passingOutYear}</td>
        </tr>
        <tr>
          <th scope="row">Percentage</th>
          <td>${educationDTO.percentage}</td>
        </tr>
