...
<body>
    ...
    <div class="container d-flex justify-content-center my-5">
        <form action="order" id="form" class="p-4 border rounded shadow" style="width: 100%; max-width: 600px;">
            ...
            <div class="mb-3">
                <label for="takeAway" class="form-label">Take Away</label>
                <select class="form-select" id="takeAway" name="takeAway">
            ...
            <div class="mb-3">
                ...
                <span id="couponError" class="error small text-danger"></span>
            </div>
    ...
    <footer class="text-center text-lg-start py-5" style="background-color: rgb(43, 239, 135);">
