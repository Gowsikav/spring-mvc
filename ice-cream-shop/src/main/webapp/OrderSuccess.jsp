...
<body>
    ...
    <p class="h4 text-success text-center my-4">Order complete for ${name}, total amount Rs.${price}/-</p>
    <img src="images/order-success-img.png" alt="Success" class="d-block mx-auto mb-4" style="width: 300px; height: 300px;">
