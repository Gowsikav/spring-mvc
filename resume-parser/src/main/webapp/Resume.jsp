    ...
    <body>
        <nav class="navbar navbar-expand-lg" style="background-color: rgb(43, 239, 135)">
            <div class="container-fluid">
                <img class="navbar-brand" src="images/resume-icon.png" alt="Logo" height="100px" />
        ...
        <div class="container d-flex justify-content-center my-5">
            <form action="resume" id="form" method="post" enctype="multipart/form-data"
                class="p-4 border rounded shadow" style="width: 100%; max-width: 600px">
                <h4 class="text-center mb-4">Send Your Resume</h4>
                <h6 class="text-center text-danger mb-4">${message}</h6>

                <div class="mb-3">
                    <label for="fullname" class="form-label">Full Name</label>
                    <input type="text" class="form-control" id="fullname" name="fullName" value="${dto.fullName}"
                        required />
                    <span id="fullnameError" class="error small text-danger"></span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="resume" name="multipartFile" />
                    <span id="resumeError" class="error small text-danger"></span>
                </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/js/bootstrap.min.js"
            ...
            crossorigin="anonymous"></script>
        <script src="js/resume-validate.js"></script>
    </body>
