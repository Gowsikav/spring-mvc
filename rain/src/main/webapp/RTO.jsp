...
<body>
    ...
    <div class="container d-flex justify-content-center my-5">
        <form action="rto" class="p-4 border rounded shadow" style="width: 100%; max-width: 600px">
            <h4 class="text-center mb-4">RTO Form</h4>

            <div class="mb-3">
                <label for="officeName" class="form-label">RTO Office Name</label>
