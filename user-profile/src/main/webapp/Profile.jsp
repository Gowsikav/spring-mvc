<%@ page isELIgnored="false" %>
    ...
    <body>
        <nav class="navbar navbar-expand-lg" style="background-color: rgb(59, 239, 89)">
            <div class="container-fluid">
                <img class="navbar-brand" src="images/profile-icon.png" alt="Logo" height="100px" />
        ...
        <div class="container my-5">
            <h1 class="display-4 text-center mb-4">Profile Details</h1>
            <form id="form" action="profile" method="post" enctype="multipart/form-data" class="mx-auto"
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="image" name="profilePicture" required />
        ...
        <footer class="text-center text-lg-start py-3" style="background-color: rgb(59, 239, 89)">
