...
<body>
    ...
    <div class="container my-5">
            <h1 class="display-4 text-center mb-4">Welcome to Excel Upload</h1>
            <p class="text-danger">${message}</p>
            <form id="form" action="upload" method="post" enctype="multipart/form-data" class="mx-auto"
    ...
    <footer class="text-center text-lg-start py-3 fixed-bottom" style="background-color: rgb(59, 239, 89);">
        <div class="text-center text-dark">&copy; 2025 Excel upload.</div>
    </footer>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
        <script src="js/excelupload-validation.js"></script>
</body>
